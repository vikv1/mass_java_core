...
public class Wave2DMass extends Place {
  ...
  */
  ...
  public static void main( String[] args ) throws Exception 
  {
	...
	//Places wave2D  = new Places( 1, "Wave2DMass", (Object)(new Integer( interval )),
                                                           boundaryWidth, wrapEdges, size, size );

    // ************************************************************************************************

    MASS.initBoundaries(wave2D);
	...
	System.out.println("exchange time: " + ea_time_total + "\tcallAll time: " + ca_time_total);
