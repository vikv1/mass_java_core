...
public class CypherDuration {
    ...
    public Object getProperty(String propertyName) {
        switch (propertyName) {
            ...
            default:
                throw new PropertyGraphCypherTypeErrorException("Cannot access property " + propertyName + " of a duration");
        }
    }
    ...
    public CypherDuration truncatedTo(ChronoUnit units) {
        ...
        switch (units) {
            ...
            default:
                throw new PropertyGraphCypherNotImplemented("Unimplemented truncate to: " + units);
        }
    }
}
