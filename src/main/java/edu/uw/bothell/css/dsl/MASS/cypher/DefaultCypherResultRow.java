...
public class DefaultCypherResultRow implements CypherResultRow {
    ...
    public CypherResultRow set(String name, Object value) {
        if (value instanceof CypherAstBase) {
            throw new PropertyGraphCypherException("Should not put cypher ast values in row");
        }
    ...
    public void popScope(int count) {
        if (scopes.size() < count) {
            throw new PropertyGraphCypherException("Not enough scopes to pop. Expected " + count + " found " + scopes.size());
        }
    ...
    public Map<String, Object> popScope() {
        if (scopes.size() == 0) {
            throw new PropertyGraphCypherException("No scopes to pop");
        }
