...
import edu.uw.bothell.css.dsl.MASS.antlr.CypherBaseVisitor;
...
import edu.uw.bothell.css.dsl.MASS.cypher.utils.StreamUtils;
...
public class PropertyGraphCypherVisitor extends CypherBaseVisitor<CypherAstBase> {
    ...
    public CypherQuery visitSingleQuery(CypherParser.OC_SingleQueryContext ctx) {
        if (ctx.oC_MultiPartQuery() != null) {
            ...
            throw new PropertyGraphCypherNotImplemented("Unhandled child: " + ctx.getText());
        }
    }
            ...
            children.stream()
                ...
                .map(c -> {
                    if (c instanceof CypherParser.OC_ReadingClauseContext) {
                        ...
                        throw new PropertyGraphCypherNotImplemented("Unhandled child (" + c.getText() + "): " + c.getClass().getName());
                    }
                })
    ...
    public CypherClause visitOC_InQueryCall(CypherParser.OC_InQueryCallContext ctx) {
        throw new PropertyGraphCypherNotImplemented("visitOC_InQueryCall: " + ctx.getText());
    }
    ...
    public CypherReturnBody visitOC_ReturnBody(CypherParser.OC_ReturnBodyContext ctx) {
        ...
        return new CypherReturnBody(
            (CypherListLiteral<CypherReturnItem>) visitOC_ReturnItems(ctx.oC_ReturnItems()),
    ...
    public CypherAstBase visitOC_PatternElementChain(CypherParser.OC_PatternElementChainContext ctx) {
        throw new PropertyGraphCypherException("should not be called, see visitPatternElementChainList");
    }
            ...
            if (child instanceof TerminalNode) {
                ...
                if (newOp != null) {
                    if (op == null) {
                        ...
                        throw new PropertyGraphCypherException("unexpected op, found too many ops in a row");
                    }
                }
            } else {
                ...
                if (left == null) {
                    ...
                    if (op == null) {
                        throw new PropertyGraphCypherException("unexpected binary expression. expected an op between expressions");
                    }
    ...
    private CypherAstBase visitOC_StringListNullOperatorExpression(List<ParseTree> children) {
        ...
        throw new PropertyGraphCypherNotImplemented("" + children.stream().map(ParseTree::getText).collect(Collectors.joining(", ")));
    }
    ...
    public CypherString visitOC_SchemaName(CypherParser.OC_SchemaNameContext ctx) {
        if (ctx.oC_SymbolicName() != null) {
            ...
            throw new PropertyGraphCypherSyntaxErrorException("Expected symbolic name or reserved word");
        }
    }
    ...
    public CypherAstBase visitOC_PartialComparisonExpression(CypherParser.OC_PartialComparisonExpressionContext ctx) {
        throw new PropertyGraphCypherNotImplemented("PartialComparisonExpression");
    }
    ...
    public CypherLimit visitOC_Limit(CypherParser.OC_LimitContext ctx) {
        ...
        if (i != null && i < 0) {
            throw new PropertyGraphCypherSyntaxErrorException("NegativeIntegerArgument: limit should only have positive arguments: " + expressionText);
        }
    ...
    public CypherBoolean visitOC_BooleanLiteral(CypherParser.OC_BooleanLiteralContext ctx) {
        ...
        throw new PropertyGraphCypherException("unexpected boolean: " + ctx.getText());
    }
    ...
    public CypherAstBase visitOC_Dash(CypherParser.OC_DashContext ctx) {
        throw new PropertyGraphCypherNotImplemented("Dash");
    }
    ...
    public CypherAstBase visitOC_RightArrowHead(CypherParser.OC_RightArrowHeadContext ctx) {
        throw new PropertyGraphCypherNotImplemented("RightArrowHead");
    }
    ...
    public CypherAstBase visitOC_LeftArrowHead(CypherParser.OC_LeftArrowHeadContext ctx) {
        throw new PropertyGraphCypherNotImplemented("LeftArrowHead");
    }
    ...
    public CypherAstBase visitOC_FunctionInvocation(CypherParser.OC_FunctionInvocationContext ctx) {
        ...
        if (fn == null) {
            throw new PropertyGraphCypherSyntaxErrorException("UnknownFunction: Could not find function with name \"" + functionName + "\"");
        }
        boolean distinct = ctx.DISTINCT() != null;
    ...
    public CypherAstBase visitOC_Parameter(CypherParser.OC_ParameterContext ctx) {
        ...
        throw new PropertyGraphCypherNotImplemented("Parameter");
    }
    ...
    public CypherMergeAction visitOC_MergeAction(CypherParser.OC_MergeActionContext ctx) {
        ...
        if (ctx.CREATE() != null) {
            ...
            throw new PropertyGraphCypherSyntaxErrorException("Expected ON CREATE or ON MATCH");
        }
    }
    ...
    public CypherSetItem visitOC_SetItem(CypherParser.OC_SetItemContext ctx) {
        if (ctx.oC_PropertyExpression() != null) {
            ...
            if (!(lookup instanceof CypherLookup)) {
                throw new PropertyGraphCypherException("expected " + CypherLookup.class.getName() + " found " + lookup.getClass().getName());
            }
    ...
    private CypherSetItem.Op getSetItemOp(CypherParser.OC_SetItemContext ctx) {
        ...
        throw new PropertyGraphCypherException("Could not find set item op: " + ctx.getText());
    }
    ...
    public CypherUnion visitOC_Union(CypherParser.OC_UnionContext ctx) {
        throw new PropertyGraphCypherNotImplemented("Union");
    }

    @Override
    public CypherAstBase visitOC_RelationshipDetail(CypherParser.OC_RelationshipDetailContext ctx) {
        throw new PropertyGraphCypherNotImplemented("RelationshipDetail");
    }
    ...
    public CypherInteger visitOC_IntegerLiteral(CypherParser.OC_IntegerLiteralContext ctx) {
        try {
            ...
            throw new PropertyGraphCypherException("could not parse \"" + ctx.getText() + "\" into integer");
        }
    }
    ...
    public CypherAstBase visitErrorNode(ErrorNode node) {
        throw new PropertyGraphCypherException(String.format(
