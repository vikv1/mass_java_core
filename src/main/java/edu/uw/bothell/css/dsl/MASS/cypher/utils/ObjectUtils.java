...
public class ObjectUtils {
    ...
    public static int compare(Object leftObj, Object rightObj) {
        ...
        try {
            ...
            try {
                ...
                throw new PropertyGraphCypherException("Could not compare: " + left + " ?= " + rightObj, ex);
            }
        } catch (Exception ex) {
            if (ex instanceof ClassCastException) {
                throw ex;
            }
            throw new PropertyGraphCypherException(
                String.format(
    ...
    public static Number sumNumbers(Stream<?> stream) {
        return stream
            ...
            .map(o -> {
                PropertyGraphCypherTypeErrorException.assertType(o, Number.class);
                return (Number) o;
            })
    ...
    public static Object divideNumbers(Number numerator, Number denominator) {
        ...
        throw new PropertyGraphCypherNotImplemented("cannot divide numbers");
    }
    ...
    public static Object modNumbers(Number a, Number b) {
        ...
        throw new PropertyGraphCypherNotImplemented("cannot mod numbers");
    }
    ...
    public static Object multiplyNumbers(Number a, Number b) {
        ...
        throw new PropertyGraphCypherNotImplemented("cannot multiply numbers");
    }
    ...
    /**
     * Similar to {@link edu.uw.bothell.css.dsl.mass.util.StreamUtils#distinctBy(Function)} but does a deep compare
     */
    ...
    private static String toKey(Object o) {
        ...
        throw new PropertyGraphCypherNotImplemented("toKey: " + o.getClass().getName());
    }
}
