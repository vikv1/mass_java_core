...
public class PropertyGraphCypherTypeErrorException extends PropertyGraphCypherException {
    private static final long serialVersionUID = 4097761075124617864L;

    public PropertyGraphCypherTypeErrorException(String message) {
        super(message);
    }

    public PropertyGraphCypherTypeErrorException(Object value, Class... acceptedClasses) {
    ...
    public static void assertType(Object value, Class... acceptedClasses) {
        ...
        throw new PropertyGraphCypherTypeErrorException(value, acceptedClasses);
    }
}
