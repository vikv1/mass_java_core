...
public class PropertyGraphCypherResult implements Stream<CypherResultRow> {
    private final Stream<CypherResultRow> stream;
    private final LinkedHashSet<String> columnNames;

    public PropertyGraphCypherResult(Stream<CypherResultRow> stream, LinkedHashSet<String> columnNames) {
        this.stream = stream;
    ...
    @Override
    public PropertyGraphCypherResult filter(Predicate<? super CypherResultRow> predicate) {
    ...
    public PropertyGraphCypherResult flatMapCypherResult(Function<? super CypherResultRow, ? extends Stream<? extends CypherResultRow>> mapper) {
        return new PropertyGraphCypherResult(
    ...
    @Override
    public PropertyGraphCypherResult distinct() {
        return new PropertyGraphCypherResult(
            stream.distinct(),
            getColumnNames()
        );
    ...
    @Override
    public PropertyGraphCypherResult sorted(Comparator<? super CypherResultRow> comparator) {
        return new PropertyGraphCypherResult(
    ...
    @Override
    public PropertyGraphCypherResult peek(Consumer<? super CypherResultRow> action) {
        return new PropertyGraphCypherResult(
            stream.peek(action),
            this.getColumnNames()
        );
