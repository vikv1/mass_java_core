...
public class ColorImageScale{
	...
	public void setpallet(Pixel[][] pixels,int start_x, int start_y, int delta_x, int delta_y){
		...
		total_pix = (delta_x * delta_y); //particular area of picture
...
//		System.out.println(total_red + " "+ total_green + " "+ total_blue);

//		double temp = 0;
//		for(int i = 1; i < 256; i++){
//
//			//System.out.print("red "+ red[i]+ "  ");
//			temp = ( (double)red[i]/ (double)256) * 100;
//			System.out.print((int)temp + "%	"); //print count of that red pixel value
//			
//			//System.out.print("green "+ green[i]+ "  ");
//			temp = ( (double)green[i] / (double)256)*100;
//			System.out.print((int)temp + "%	");
//			
//			//System.out.print("blue "+ blue[i]+"  "); 
//			temp = ( (double)blue[i] / (double)256)*100;			
